...
public class PackagePage extends JFrame implements ActionListener {
        ...
        int people;
        JButton back, book3Day, book5Day, book7Day, aboutUs;
        ...
        public void actionPerformed(ActionEvent e) {
                if (e.getSource() == back) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                        "Redirecting to Hotels Page for booking 3 day package for " + people
                                                        + " members ! ",
                                        "Booking Confirmation", JOptionPane.INFORMATION_MESSAGE);
                        new HotelsPage(userName, destination, 3, selectedPackage, people, selectedPickUp)
                                        .setVisible(true);
                } else if (e.getSource() == book5Day) {
                        this.setVisible(false);
                        JOptionPane.showMessageDialog(null,
                                        "Redirecting to Hotels Page for booking 5 day package for " + people
                                                        + " members ! ",
                                        "Booking Confirmation", JOptionPane.INFORMATION_MESSAGE);
                        new HotelsPage(userName, destination, 5, selectedPackage, people, selectedPickUp)
                                        .setVisible(true);
                } else if (e.getSource() == book7Day) {
                        this.setVisible(false);
                        JOptionPane.showMessageDialog(null,
                                        "Redirecting to Hotels Page for booking 7 day package for " + people
                                                        + " members ! ",
                                        "Booking Confirmation", JOptionPane.INFORMATION_MESSAGE);
                        new HotelsPage(userName, destination, 7, selectedPackage, people, selectedPickUp)
                                        .setVisible(true);
                }
